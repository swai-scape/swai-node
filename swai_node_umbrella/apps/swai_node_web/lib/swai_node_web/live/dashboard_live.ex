defmodule SwaiNodeWeb.DashboardLive do
  @moduledoc """
  Simplified Dashboard LiveView for SwaiNode.

  Shows:
  - Header with controls and basic stats
  - Prominent arena canvas
  - Population graphs by behavioral type
  """
  ...
  def render(assigns) do
    ...
    <div class="h-screen bg-gray-900 text-white flex flex-col overflow-hidden">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="flex items-center gap-1">
              ...
              <button phx-click="reset" class="px-3 py-1 bg-red-600 hover:bg-red-500 rounded text-sm font-medium transition-colors">
                Reset
              </button>
            </div>
          </div>
          ...
          <div class="flex items-center gap-6 text-sm">
            <div class="flex items-center gap-2">
              ...
              <span class="font-mono text-white">{@stats.tick}</span>
            </div>
            <div class="flex items-center gap-2">
              <span class="text-gray-400">Pop</span>
              <span class="font-mono text-cyan-400">{@stats.population}</span>
            </div>
            <div class="flex items-center gap-2">
              <span class="text-gray-400">Gen</span>
              <span class="font-mono text-purple-400">{@stats.generation}</span>
            </div>
            <div class="flex items-center gap-2">
              <span class="text-gray-400">Kills</span>
              <span class="font-mono text-red-400">{@stats.total_kills}</span>
            </div>
            <div class="flex items-center gap-2">
              <span class="text-gray-400">Best</span>
              <span class="font-mono text-yellow-400">{format_number(@stats.best_fitness)}</span>
            </div>
          </div>
        </div>
      </header>
      ...
      <main class="flex-1 flex flex-col p-4 gap-4 min-h-0">
        ...
        <div class="h-32 bg-gray-800 rounded-lg p-3 flex-shrink-0">
          <div class="flex items-center justify-between mb-2">
            <h2 class="text-sm font-medium text-gray-300">Population by Behavior</h2>
            <div class="flex items-center gap-4 text-xs">
              <div class="flex items-center gap-1">
                <span class="w-3 h-3 rounded-full bg-green-500"></span>
                <span class="text-gray-400">Herbivore</span>
                <span class="font-mono text-green-400">{@behavioral_types.herbivore}</span>
              </div>
              <div class="flex items-center gap-1">
                <span class="w-3 h-3 rounded-full bg-yellow-500"></span>
                <span class="text-gray-400">Omnivore</span>
                <span class="font-mono text-yellow-400">{@behavioral_types.omnivore}</span>
              </div>
              <div class="flex items-center gap-1">
                <span class="w-3 h-3 rounded-full bg-red-500"></span>
                <span class="text-gray-400">Carnivore</span>
  ...
  # Simple SVG area chart for behavioral types
